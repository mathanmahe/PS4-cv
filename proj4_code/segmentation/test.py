...
from proj4_code.segmentation.avg_meter import AverageMeter
from proj4_code.segmentation.dataset import SemData
...
from proj4_code.segmentation.trainer import DEFAULT_ARGS
from proj4_code.segmentation.utils import load_class_names, get_imagenet_mean_std, get_logger, normalize_img
from proj4_code.segmentation.accuracy_calculator import AccuracyCalculator
...
if __name__ == '__main__':
    args = DEFAULT_ARGS
    args.model_path = "" #build own path
    test_model(args)
